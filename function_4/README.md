For this function, I try four different types of codes. I found Monte_carlo_EI_4.ipynb most successful in finding maximum observation. Following are details of the code files in this folder. 
