For this function, I try four different types of codes. I found BO_UCB_2 most successful in finding maximum observation. Following are details of the code files in this folder. 
